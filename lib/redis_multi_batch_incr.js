 ...
 * @memberof redisMultiBatchIncr
 * 
 * @property {Object} redisClient The instance of ioredis client.
 * @property {String} cmd The name of redis command.
 * @property {Number} [loopInterval=200] The milliseconds of the interval to send a batch of commands.
 * @property {Number} [expireTime] The seconds used to set the redis key.
 */

/**
 * The class for sending batch redis commands.
 * @class RedisMultiBatchIncr
 * @abstract
 * @memberof redisMultiBatchIncr
 */
 ...
 * @class BatchMultiZincrby
 * @extends RedisMultiBatchIncr
 * @memberof redisMultiBatchIncr
 */
